...
export default async function CheckoutPage() {
  const [zonas, cuentasPago] = await Promise.all([getZonasEnvioActivas(), getCuentasPago()])
  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-12 md:px-10">
      ...
      <div className="mt-8">
        <CheckoutForm zonas={zonas} mpEnabled={mpConfigured()} cuentasPago={cuentasValidas} />
      </div>
    </div>
  )
}
