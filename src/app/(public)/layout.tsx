...
import { BeneficiosProvider } from '@/components/public/beneficios-precio'
import { Toaster } from '@/components/ui/sonner'

export default async function PublicLayout({ children }: { children: React.ReactNode }) {
  const [marca, navLinks, categorias, isAdmin, cupon, cintillo, beneficios] = await Promise.all([
    getMarcaConfig(),
    getNavLinks(),
    getCategorias(),
    getIsAdmin(),
  ...
  return (
    <CartProvider>
      <BeneficiosProvider value={beneficios}>
